...
В `main()` програмата създайте 3 нови обекта, които да показват възможностите на трите конструктора. След създаването на всеки обект, извикайте и метода за отпечатване на информацията.
