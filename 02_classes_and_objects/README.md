...
Допълнете програмата от задача 8 и добавете динамично създаване на обект от класа `Point`, чийто адрес да се съхранява в указател, и осигурите освобождаване на паметта.
